...
class _MyPostCard extends StatelessWidget {
  ...
  void _showTaskViewersSheet(BuildContext context) {
    ...
    showModalBottomSheet<void>(
      ...
      builder:
          (_) => _OwnerTaskViewersSheet(taskId: taskId!, totalCount: viewCount),
    );
  }
}
...
class _OwnerTaskViewersSheet extends StatefulWidget {
  const _OwnerTaskViewersSheet({required this.taskId, required this.totalCount});

  final String taskId;
  final int totalCount;

  @override
  State<_OwnerTaskViewersSheet> createState() => _OwnerTaskViewersSheetState();
}

class _OwnerTaskViewersSheetState extends State<_OwnerTaskViewersSheet> {
                                  ...
                                  viewer.avatarUrl != null &&
                                      ...
                                      ? ClipOval(
                                        child: OptimizedNetworkImage(
                                          ...
                                          cacheWidth: 80,
                                          cacheHeight: 80,
                                          errorWidget: _OwnerTaskFallbackAvatar(
                                            initials: initials,
                                          ),
                                        ),
                                      )
                                      : _OwnerTaskFallbackAvatar(
                                        initials: initials,
                                      ),
                            ),
                            title: Text(
...
class _OwnerTaskFallbackAvatar extends StatelessWidget {
  const _OwnerTaskFallbackAvatar({required this.initials});
